//
//  GetMyDesignerListNetworkService.m
//  Chair
//
...
@implementation GetMyDesignerListNetworkService
...
- (void)getMyDesignerListRequest:(NSInteger)customerId {
    ...
    _aURLString = [_aURLString stringByAppendingString:@"/designer/mydesignerlist"];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    //결과가 있으면 myDesignerList에 넣고, 없으면 넘긴다.
    if(responseDataDic == nil || [responseDataDic count] == 0) {
    } else {
        ([MyDesignerList getMyDesignerListObject].myDesignerList) = responseDataDic;
    }
